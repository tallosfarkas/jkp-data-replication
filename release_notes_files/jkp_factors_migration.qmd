...
plt.show()
```
Here, factors differ more than in the U.S. sample. However, performance remains strong: only 9 out of 153 factors have a correlation below 0.90, and only 3 fall below 0.80.
...
- **Numerical precision:** Small differences in floating-point behavior between SAS and Python can flip inequality evaluations at the margin.
